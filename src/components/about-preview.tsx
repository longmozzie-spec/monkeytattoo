    ...
    <section className="py-32 px-6">
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
        <div className="lg:col-span-3">
          <ScrollReveal>
            <h2 className="font-display text-4xl md:text-6xl font-extrabold uppercase tracking-tighter leading-[0.9]">
              Không chỉ là
              <br />
  ...
  return (
    <section className="py-32 px-6 bg-surface">
      <div className="max-w-[1400px] mx-auto">
        <ScrollReveal>
          <h2 className="font-display text-4xl md:text-6xl font-extrabold uppercase tracking-tighter leading-[0.9] mb-4">
            Dàn Nhân Sự
            <br />
